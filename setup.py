...
setup(platforms=['all'],
      ...
      install_requires=['ally_core_http == 1.0', 'ally-plugin >= 1.0', 'ally-hr-user >= 1.0', 'ally-security-user >= 1.0', 'ally-indexing-provider >= 1.0', 'ally-service-assemblage >= 1.0', 'ally-patch-praha'],
